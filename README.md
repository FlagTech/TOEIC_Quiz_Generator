...
針對單一題型反覆練習，不需要每次都做完整份測驗。

<!-- TODO: 補上題型測驗畫面截圖 -->

- Part 1：照片描述，生成圖片、語音選項與答案。
- Part 2：應答問題，生成聽力問句與選項。
- Part 3：簡短對話，生成對話音檔、題組與選項。
...
想練速度與作答節奏時，可以直接生成 Listening 或 Reading 全卷。

<!-- TODO: 補上模擬測驗畫面截圖 -->

- Listening 模擬測驗涵蓋 Part 1-4。
- Reading 模擬測驗涵蓋 Part 5-7。
- 支援背景生成，不必卡在等待畫面。
- 生成中斷或失敗時，可接續未完成的進度。

✅ **AI 詳解與錯題檢討**

提交答案後，可以產生詳解，快速理解選項為什麼正確或錯誤。
...
- Part 6 / Part 7 文章支援 Markdown 排版，長文不再擠成一團。

✅ **共用歷史紀錄側邊欄**

題型測驗與模擬測驗會集中在同一個側邊欄，方便回頭複習。
...
Reading 模擬測驗可匯出成 PDF，方便列印、保存或離線練習。
